...
public class ForumUserTestSuite {
    ...
    public void testGetLocationOfFriends() {
        ...
        //   user7:  "Washington"
        //   user10: "Miami"
        Assert.assertEquals(3, user1.getFriendLocation().size());
        Assert.assertTrue(user1.getFriendLocation().contains("Key West"));
        Assert.assertTrue(user1.getFriendLocation().contains("Washington"));
        Assert.assertTrue(user1.getFriendLocation().contains("Miami"));
        Assert.assertFalse(user1.getFriendLocation().contains("Orlando"));
    }
    ...
    public void testGetLocationsOfFriendsOfFriends() {
        ...
        Assert.assertEquals(3, user1.getFriendOfFriendLocalization().size());
        Assert.assertTrue(user1.getFriendOfFriendLocalization().contains("Key West"));
        Assert.assertTrue(user1.getFriendOfFriendLocalization().contains("Washington"));
        Assert.assertTrue(user1.getFriendOfFriendLocalization().contains("Miami"));
        Assert.assertFalse(user1.getFriendOfFriendLocalization().contains("Orlando"));
